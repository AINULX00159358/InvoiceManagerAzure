...
function updateServiceName(svcName){
    serviceName = svcName;
}
...
module.exports = { updateServiceName, newInvoice, register, payment, createCloudEventResponse, createJsonResponse, createJsonPayment, validate, createCloudEvent  }